...
RUN python3 -c "import nltk; import os; nltk.data.path.append('/tmp/nltk_data'); os.makedirs('/tmp/nltk_data', exist_ok=True); nltk.download('stopwords', download_dir='/tmp/nltk_data', quiet=True); nltk.download('wordnet', download_dir='/tmp/nltk_data', quiet=True); nltk.download('punkt', download_dir='/tmp/nltk_data', quiet=True); nltk.download('omw-1.4', download_dir='/tmp/nltk_data', quiet=True)"
