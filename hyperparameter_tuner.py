...
class ProductionHyperparameterTuner:
    ...
    def setup_mlflow(self, experiment_name):
        ...
        try:
            ...
            self.logger.warning(f"MLflow setup failed: {e}. Continuing without tracking.")
    ...
    def optimize_model(self, X_train, y_train, model_type='logistic_regression', n_trials=100):
        ...
        if model_type == 'logistic_regression':
            objective_func = lambda trial: self.objective_logistic_regression(trial, X_train, y_train)
        else:
        ...
        best_params_converted = self._convert_params_from_optuna(study.best_trial.params, model_type)
    ...
    def train_best_model(self, X_train, y_train, X_val, y_val, best_params, model_type='logistic_regression'):
